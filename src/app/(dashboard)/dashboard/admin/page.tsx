  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <KPICard title="Total Revenue" value={stats?.totalRevenue ?? 0} prefix="$" decimals={0} icon={TrendingUp} variant="revenue" isLoading={isLoading} />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <DashboardChartCard title="Revenue Overview" subtitle="Monthly revenue trend" isLoading={isLoading} delay={0.1} skeletonHeight={300}
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <DashboardChartCard title="Revenue by Property" subtitle="Breakdown across portfolio" isLoading={isLoading} delay={0.2} skeletonHeight={300}>
          <ResponsiveContainer width="100%" height={300}>
        ...
        <DashboardWidget title="Recent Activity" description="System-wide events" isLoading={isLoading} delay={0.25}>
          <ActivityTimeline
